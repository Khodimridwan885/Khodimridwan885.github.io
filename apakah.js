...
document.getElementById("bq").onclick = function() {
  ...
  if(jawaban && jawaban.length < 19){
    ...
    await swals.fire('OK!', 'Kirim jawabannya ke Instagram aku, ya!', 'success');
    window.location = "https://www.instagram.com/rdwn08__?igsh=MWJlcWw1eXppMzJhYw==" + pesanwhatsapp;
    tombol();
  } else {
